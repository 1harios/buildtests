 ...
 */
type InferIntersectInput<TOptions extends IntersectOptions | IntersectOptionsAsync> = TOptions extends MaybeReadonly<[
 ...
 */
type InferIntersectOutput<TOptions extends IntersectOptions | IntersectOptionsAsync> = TOptions extends MaybeReadonly<[
 ...
 */
declare function config<TSchema extends BaseSchema<unknown, unknown, BaseIssue<unknown>> | BaseSchemaAsync<unknown, unknown, BaseIssue<unknown>>>(schema: TSchema, config: Omit<Config<InferIssue<TSchema>>, 'skipPipe'>): TSchema;
 ...
 * Flat errors type.
 */
interface FlatErrors<TNestedPath extends string> {
    /**
     * The root errors.
     *
     ...
     */
    readonly nested?: Prettify<Readonly<Partial<Record<TNestedPath, [string, ...string[]]>>>>;
    /**
     * The other errors.
     *
 ...
 */
declare function flatten(issues: [BaseIssue<unknown>, ...BaseIssue<unknown>[]]): Prettify<FlatErrors<string>>;
/**
 * Flatten the error messages of schema issues.
 *
 * @param issues The schema issues.
 ...
 * @returns A flat error object.
 */
declare function flatten<TSchema extends BaseSchema<unknown, unknown, BaseIssue<unknown>> | BaseSchemaAsync<unknown, unknown, BaseIssue<unknown>>>(issues: [InferIssue<TSchema>, ...InferIssue<TSchema>[]]): Prettify<FlatErrors<IssueDotPath<TSchema>>>;
...
type PathTuple<TValue, TKey extends keyof TValue> = TKey extends TKey ? [
    ...
    }[TValue[TKey] extends Blob | Date | Map<unknown, unknown> | Set<unknown> ? 0 : TValue[TKey] extends unknown[] ? 1 : TValue[TKey] extends Record<string, unknown> ? 2 : 0]
] : never;
/**
 * Path keys type.
 */
type PathKeys<TInput extends Record<string, unknown> | unknown[]> = TInput extends unknown[] ? PathTuple<TInput, number> : PathTuple<TInput, keyof TInput>;
 ...
 */
declare function forward<TInput extends Record<string, unknown> | unknown[], TIssue extends BaseIssue<unknown>>(action: BaseValidation<TInput, TInput, TIssue>, pathKeys: PathKeys<TInput>): BaseValidation<TInput, TInput, TIssue>;
 ...
 * @returns The modified action.
 */
declare function forwardAsync<TInput extends Record<string, unknown> | unknown[], TIssue extends BaseIssue<unknown>>(action: BaseValidation<TInput, TInput, TIssue> | BaseValidationAsync<TInput, TInput, TIssue>, pathKeys: PathKeys<TInput>): BaseValidationAsync<TInput, TInput, TIssue>;
 ...
 */
declare function parse<const TSchema extends BaseSchema<unknown, unknown, BaseIssue<unknown>>>(schema: TSchema, input: unknown, config?: Omit<Config<InferIssue<TSchema>>, 'skipPipe'>): InferOutput<TSchema>;
 ...
 * @returns The parsed input.
 */
declare function parseAsync<const TSchema extends BaseSchema<unknown, unknown, BaseIssue<unknown>> | BaseSchemaAsync<unknown, unknown, BaseIssue<unknown>>>(schema: TSchema, input: unknown, config?: Omit<Config<InferIssue<TSchema>>, 'skipPipe'>): Promise<InferOutput<TSchema>>;

/**
 * The parser type.
 */
interface Parser<TSchema extends BaseSchema<unknown, unknown, BaseIssue<unknown>>, TConfig extends Omit<Config<InferIssue<TSchema>>, 'skipPipe'> | undefined> {
    /**
 ...
 * @returns The parser function.
 */
declare function parser<const TSchema extends BaseSchema<unknown, unknown, BaseIssue<unknown>>, const TConfig extends Omit<Config<InferIssue<TSchema>>, 'skipPipe'> | undefined>(schema: TSchema, config: TConfig): Parser<TSchema, TConfig>;

/**
 * The parser async type.
 */
interface ParserAsync<TSchema extends BaseSchema<unknown, unknown, BaseIssue<unknown>> | BaseSchemaAsync<unknown, unknown, BaseIssue<unknown>>, TConfig extends Omit<Config<InferIssue<TSchema>>, 'skipPipe'> | undefined> {
    /**
     * Parses an unknown input based on the schema.
     */
 ...
 * @returns The parser function.
 */
declare function parserAsync<const TSchema extends BaseSchema<unknown, unknown, BaseIssue<unknown>> | BaseSchemaAsync<unknown, unknown, BaseIssue<unknown>>, const TConfig extends Omit<Config<InferIssue<TSchema>>, 'skipPipe'> | undefined>(schema: TSchema, config: TConfig): ParserAsync<TSchema, TConfig>;
 ...
 */
type PartialEntries$1<TEntries extends ObjectEntries, TKeys extends MaybeReadonly<(keyof TEntries)[]> | undefined> = {
    [TKey in keyof TEntries]: TKeys extends MaybeReadonly<(keyof TEntries)[]> ? TKey extends TKeys[number] ? OptionalSchema<TEntries[TKey], never> : TEntries[TKey] : OptionalSchema<TEntries[TKey], never>;
};
/**
 ...
 * Partial entries type.
 */
type PartialEntries<TEntries extends ObjectEntriesAsync, TKeys extends MaybeReadonly<(keyof TEntries)[]> | undefined> = {
    [TKey in keyof TEntries]: TKeys extends MaybeReadonly<(keyof TEntries)[]> ? TKey extends TKeys[number] ? OptionalSchemaAsync<TEntries[TKey], never> : TEntries[TKey] : OptionalSchemaAsync<TEntries[TKey], never>;
};
/**
 * Schema with partial type.
 */
 ...
 */
type RequiredEntries$1<TEntries extends ObjectEntries, TKeys extends MaybeReadonly<(keyof TEntries)[]> | undefined, TMessage extends ErrorMessage<NonOptionalIssue> | undefined> = {
    [TKey in keyof TEntries]: TKeys extends MaybeReadonly<(keyof TEntries)[]> ? TKey extends TKeys[number] ? NonOptionalSchema<TEntries[TKey], TMessage> : TEntries[TKey] : NonOptionalSchema<TEntries[TKey], TMessage>;
};
/**
 ...
 * Required entries type.
 */
type RequiredEntries<TEntries extends ObjectEntriesAsync, TKeys extends MaybeReadonly<(keyof TEntries)[]> | undefined, TMessage extends ErrorMessage<NonOptionalIssue> | undefined> = {
    [TKey in keyof TEntries]: TKeys extends MaybeReadonly<(keyof TEntries)[]> ? TKey extends TKeys[number] ? NonOptionalSchemaAsync<TEntries[TKey], TMessage> : TEntries[TKey] : NonOptionalSchemaAsync<TEntries[TKey], TMessage>;
};
/**
 * Schema with required type.
 */
 ...
 */
declare function safeParse<const TSchema extends BaseSchema<unknown, unknown, BaseIssue<unknown>>>(schema: TSchema, input: unknown, config?: Omit<Config<InferIssue<TSchema>>, 'skipPipe'>): SafeParseResult<TSchema>;
 ...
 * @returns The parse result.
 */
declare function safeParseAsync<const TSchema extends BaseSchema<unknown, unknown, BaseIssue<unknown>> | BaseSchemaAsync<unknown, unknown, BaseIssue<unknown>>>(schema: TSchema, input: unknown, config?: Omit<Config<InferIssue<TSchema>>, 'skipPipe'>): Promise<SafeParseResult<TSchema>>;

/**
 * The safe parser type.
 */
interface SafeParser<TSchema extends BaseSchema<unknown, unknown, BaseIssue<unknown>>, TConfig extends Omit<Config<InferIssue<TSchema>>, 'skipPipe'> | undefined> {
    /**
     * Parses an unknown input based on the schema.
     */
 ...
 * @returns The parser function.
 */
declare function safeParser<const TSchema extends BaseSchema<unknown, unknown, BaseIssue<unknown>>, const TConfig extends Omit<Config<InferIssue<TSchema>>, 'skipPipe'> | undefined>(schema: TSchema, config: TConfig): SafeParser<TSchema, TConfig>;

/**
 * The safe parser async type.
 */
interface SafeParserAsync<TSchema extends BaseSchema<unknown, unknown, BaseIssue<unknown>> | BaseSchemaAsync<unknown, unknown, BaseIssue<unknown>>, TConfig extends Omit<Config<InferIssue<TSchema>>, 'skipPipe'> | undefined> {
    /**
     * Parses an unknown input based on the schema.
     */
 ...
 * @returns The parser function.
 */
declare function safeParserAsync<const TSchema extends BaseSchema<unknown, unknown, BaseIssue<unknown>> | BaseSchemaAsync<unknown, unknown, BaseIssue<unknown>>, const TConfig extends Omit<Config<InferIssue<TSchema>>, 'skipPipe'> | undefined>(schema: TSchema, config: TConfig): SafeParserAsync<TSchema, TConfig>;
...
interface BaseTransformation<TInput, TOutput, TIssue extends BaseIssue<unknown>> {
     ...
     * @internal
     */
    _run(dataset: TypedDataset<TInput, never>, config: Config<TIssue>): TypedDataset<TOutput, TIssue>;
    /**
     * Input, output and issue type.
     *
     * @internal
...
interface BaseTransformationAsync<TInput, TOutput, TIssue extends BaseIssue<unknown>> extends Omit<BaseTransformation<TInput, TOutput, TIssue>, 'reference' | 'async' | '_run'> {
     ...
     * @internal
     */
    _run(dataset: TypedDataset<TInput, never>, config: Config<TIssue>): Promise<TypedDataset<TOutput, TIssue>>;
}
/**
 ...
 * the issue.
 */
type IssuePathItem = ArrayPathItem | MapPathItem | ObjectPathItem | RecordPathItem | SetPathItem | TuplePathItem | UnknownPathItem;
/**
 * Schema issue type.
 */
 ...
 */
type ContentRequirement<TInput extends ContentInput> = TInput extends unknown[] ? TInput[number] : TInput;
/**
 * Length input type.
 */
 ...
 * Requirement type.
 */
type Requirement$2<TInput extends unknown[]> = (element: TInput[number], index: number, array: TInput) => boolean;
/**
 * Every issue type.
 */
interface EveryIssue<TInput extends unknown[]> extends BaseIssue<TInput> {
    /**
     * The issue kind.
     */
    readonly kind: 'validation';
     ...
     * The validation function.
     */
    readonly requirement: Requirement$2<TInput>;
}
/**
 * Every action type.
 */
interface EveryAction<TInput extends unknown[], TMessage extends ErrorMessage<EveryIssue<TInput>> | undefined> extends BaseValidation<TInput, TInput, EveryIssue<TInput>> {
    /**
     * The action type.
     */
    readonly type: 'every';
 ...
 */
declare function every<TInput extends unknown[]>(requirement: Requirement$2<TInput>): EveryAction<TInput, undefined>;
/**
 * Creates an every validation action.
 *
 * @param requirement The validation function.
 ...
 * @returns An every action.
 */
declare function every<TInput extends unknown[], const TMessage extends ErrorMessage<EveryIssue<TInput>> | undefined>(requirement: Requirement$2<TInput>, message: TMessage): EveryAction<TInput, TMessage>;
 ...
 * Requirement type.
 */
type Requirement$1 = MaybeReadonly<`${string}/${string}`[]>;
/**
 * MIME type issue type.
 */
interface MimeTypeIssue<TInput extends Blob, TRequirement extends Requirement$1> extends BaseIssue<TInput> {
    /**
     * The issue kind.
     */
    readonly kind: 'validation';
 ...
 */
interface MimeTypeAction<TInput extends Blob, TRequirement extends Requirement$1, TMessage extends ErrorMessage<MimeTypeIssue<TInput, TRequirement>> | undefined> extends BaseValidation<TInput, TInput, MimeTypeIssue<TInput, TRequirement>> {
    /**
     * The action type.
     */
    readonly type: 'mime_type';
 ...
 */
declare function mimeType<TInput extends Blob, const TRequirement extends Requirement$1>(requirement: TRequirement): MimeTypeAction<TInput, TRequirement, undefined>;
/**
 * Creates a [MIME type](https://developer.mozilla.org/docs/Web/HTTP/Basics_of_HTTP/MIME_types) validation action.
 *
 * @param requirement The MIME types.
 ...
 * @returns A MIME type action.
 */
declare function mimeType<TInput extends Blob, const TRequirement extends Requirement$1, const TMessage extends ErrorMessage<MimeTypeIssue<TInput, TRequirement>> | undefined>(requirement: TRequirement, message: TMessage): MimeTypeAction<TInput, TRequirement, TMessage>;
 ...
 * Requirement type.
 */
type Requirement<TInput extends unknown[]> = (element: TInput[number], index: number, array: TInput) => boolean;
/**
 * Some issue type.
 */
interface SomeIssue<TInput extends unknown[]> extends BaseIssue<TInput> {
    /**
     * The issue kind.
     */
    readonly kind: 'validation';
 ...
 * Some action type.
 */
interface SomeAction<TInput extends unknown[], TMessage extends ErrorMessage<SomeIssue<TInput>> | undefined> extends BaseValidation<TInput, TInput, SomeIssue<TInput>> {
    /**
     * The action type.
     */
    readonly type: 'some';
 ...
 */
declare function some<TInput extends unknown[]>(requirement: Requirement<TInput>): SomeAction<TInput, undefined>;
/**
 * Creates a some validation action.
 *
 * @param requirement The validation function.
 ...
 * @returns A some action.
 */
declare function some<TInput extends unknown[], const TMessage extends ErrorMessage<SomeIssue<TInput>> | undefined>(requirement: Requirement<TInput>, message: TMessage): SomeAction<TInput, TMessage>;
 ...
 */
type GlobalConfig = Omit<Config<never>, 'message' | 'skipPipe'>;
/**
 ...
 * @internal
 */
declare function _addIssue<const TContext extends BaseSchema<unknown, unknown, BaseIssue<unknown>> | BaseSchemaAsync<unknown, unknown, BaseIssue<unknown>> | BaseValidation<unknown, unknown, BaseIssue<unknown>> | BaseValidationAsync<unknown, unknown, BaseIssue<unknown>>>(context: TContext, label: string, dataset: Dataset<unknown, BaseIssue<unknown>>, config: Config<InferIssue<TContext>>, other?: Other<InferInput<TContext>>): void;
 ...
 * @internal
 */
declare function _isAllowedObjectKey(key: string): boolean;
 ...
 */
declare function entriesFromList<const TList extends MaybeReadonly<string[]>, const TSchema extends BaseSchema<unknown, unknown, BaseIssue<unknown>>>(list: TList, schema: TSchema): Record<TList[number], TSchema>;
