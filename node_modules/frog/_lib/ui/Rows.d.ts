...
export declare function Rows<vars extends Vars>({ children, ...rest }: RowsProps<vars>): import("hono/jsx/jsx-dev-runtime").JSX.Element;
...
export declare function Row<vars extends Vars>({ children, height, ...rest }: RowProps<vars>): import("hono/jsx/jsx-dev-runtime").JSX.Element;
