...
export declare function HStack<vars extends Vars>({ alignHorizontal, alignVertical, children, wrap, ...rest }: HStackProps<vars>): import("hono/jsx/jsx-dev-runtime").JSX.Element;
