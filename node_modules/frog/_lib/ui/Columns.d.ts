...
export declare function Columns<vars extends Vars>({ children, ...rest }: ColumnsProps<vars>): import("hono/jsx/jsx-dev-runtime").JSX.Element;
...
export declare function Column<vars extends Vars>({ children, width, ...rest }: ColumnProps<vars>): import("hono/jsx/jsx-dev-runtime").JSX.Element;
