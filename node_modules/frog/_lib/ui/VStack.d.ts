...
export declare function VStack<vars extends Vars>({ alignHorizontal, alignVertical, children, ...rest }: VStackProps<vars>): import("hono/jsx/jsx-dev-runtime").JSX.Element;
