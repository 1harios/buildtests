...
export type Account<address extends Address = Address> = OneOf<JsonRpcAccount<address> | LocalAccount<string, address>>;
...
export type LocalAccount<source extends string = string, address extends Address = Address> = CustomSource & {
    address: address;
    publicKey: Hex;
    source: source;
    type: 'local';
